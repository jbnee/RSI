...
print,da  ;day of data
   ...
   ;Sw ='      file:'+s1+'_'+s2;used to print title
    ...
    nf1=1;    :starting file it is 1 if at the beginning     ;
    nf2=NF;  -nf1
   ;Read,nf1,nf1,prompt='starting and ending file number: '
     m=NF; -nf1+1  ;m is the number of total files for example 200 with 100 parallel 100 perpendicular
    DATAB=FLTARR(2,Nbin)
