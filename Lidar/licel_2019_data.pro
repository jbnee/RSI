...
plot,P[nf1,*]/1.e6,ht,color=2, background=0,xrange=[0,500],yrange=[h1,h2],position=p1,xtitle='time (min)',ytitle='km',$
title=XC,charsize=2
...
plot,meanP,ht,color=2, background=1,yrange=[h1,h2],position=p3,xtitle='Intensity',ytitle='km',charsize=2
maxA=max(A[0,*])
...
!p.multi=[0,1,1]
   ...
   contour,CPPM,x,y,xtitle='m channel time starting 19:30PM',ytitle='km',xrange=[0,nf3-1],yrange=[5,h2],LEVELS = CLEVS, /FILL,$
