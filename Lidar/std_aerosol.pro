Pro STD_Aerosol  ;profile of standard deviation of profiles
close,/all
!P.MULTI = [0, 2, 2]
...
plot,Meansig_D,ht1,background=-2,color=2,yrange=[0,z],xrange=[0,pksigd],$
 ...
 p22=ht1(htpksigd)          ;peak ht of pr2d
 pkdata=fltarr(2,4)
 P=[[p11,p12],[p21,p22]]
...
stop
;outnm='d:\Lidar systems\LidarPro\depolar\outputplt\'+filenm+'STD.jpg'
;outnm='d:\Lidar systems\LidarPro\depolar\figure plots\'+'STD_'+filenm+'jpg'
...
print,'peak d values, ht  ',max(avstds_D),ht1(htpkd)
 ...
 y1=0
 y2=q11/2
plot,ht1,meansig_M,background=-2,color=2,psym=0,xrange=[0,z],position=plot_position5,xtitle='m',title='Figure 2'
...
xyouts,z*.5,y2*25,'++mean pr2m',color=3
xyouts,z*0.8,y2*25,p12,color=3
xyouts,z*0.5,y2*15,'--- 10*norm.STDV pr2m',color=3
;oplot,ht1,meansig_M/p11,psym=1,color=2
xyouts,z*0.8,y2*10,q12,color=3

plot,ht1,meansig_D,background=-2,color=2,psym=0,xrange=[0,z],position=plot_position6,xtitle='m',title='Figure 3'
...
stop
;outnm2='d:\Lidar systems\LidarPro\depolar\figure plots\'+'pk_STD_'+filenm+'jpg'
