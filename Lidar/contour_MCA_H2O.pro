...
h2=5
 ...
 ;BAR_POSITION1=[0.97,0.2,0.99,0.45]
  BAR_POSITION=[0.97,0.1,0.99,0.5]
  ...
  maxa=max(Pr2m[0,b1:b2])
    ...
    for k=0,nf-ni-1,5 do begin
     sum5=pr2m[k,8]+pr2m[k+1,*]+pr2m[k+2,*]+pr2m[k+3,*]+pr2m[k+4,*]
     pr2m_5=total(sum5,1)/5
     oplot,smooth(pr2m_5,20)+k*10,ht1,color=2
 ...
 contour,pr2m,x,y,xtitle=' time',ytitle='km',xrange=[0,nf-ni],yrange=[0,h2],LEVELS = CLEVS, /FILL,$
