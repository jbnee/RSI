pro contour_lidar
fig_fn='d:\lidarsystem\figure\'
file=fig_fn+'ja032325_licle_MD_V1.eps'
file1=fig_fn+'2003mr18.eps'
fn='d:\lidar systems\ja Licel\ja032325*'
 ; fn='d:\lidar systems\lidarpro\depolar\2002\mr18\mr182309'
;readlidardata_mie,fn,day,starttime,ch_d,ch_m,DR,int532
 ;readSR430,fn,day,starttime,ch_ram
; close,/all

;file_basename1='d:\Lidar systems\LidarPro\Depolar\2002\mr31\mr312023.'

;read,ni,nf, prompt='ad,ni,nf,prompt=Initial and file number as 1,99: '
;j=0
