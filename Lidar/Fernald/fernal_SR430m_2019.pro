...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   F4=strtrim(fix(n2),2)
    ...
    ;oplot,meanbeta,ht,color=100,thick=2
     stop
     ;;save plot
      out_plot2=OUT_path+fnm+'M_beta_9'+'.png'
      write_png,out_plot2,tvrd()


      close,2

      outdata1=out_path+fnm+'M_beta10km.txt'
      ...
      stop
      km=1000.0
      Ba_km=km*beta_a[*,0:b2-1]; in km unit
      ...
      stop
      out_plot3=OUT_path+fnm+'M_EXT50'+'.png'
     ...
     stop    ;Section III
      out_file4=out_path+fnm+'M_BK_ratioav'+'.png'
     write_png,out_file4,tvrd()
