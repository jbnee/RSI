Pro contour_licel_SEARCH_PLOT
;;;;;;need input file as FILES2009JUL.TXT which list filename and file number
;;;;;input change bnum bin number and H1, H2 height region
;;;;;;;;;;;;;;;;;;;;;;;;cirrus bnum=4000
;;;;;;;;
ERASE
close,/all
...
;path='d:\LidarPro\Rayleigh\1995\se\se112342.';.'
 ...
 PATH1='F:\RSI\LIDAR\DATA_list\FILES2009AUG.TXT'
...
; read,ni,nf, prompt='Initial and file number as 1,99: '
 ...
 FOR n=ni,nf do begin
  ...
  cmax=3.*max(pr2m[nf-ni-nx/2,10:200]);400;1500;500;./2
...
wait,2
 ...
 FOR nd=ni+1,nf do begin
  ...
  col = 240 ; don't change it
  cmaxd=3.0*max(pr2d[nf-ni-nx/2,10:200]);300;   0./5
  cmind=cmaxd/180
   nlevs_max =10
 ...
 ; plot a color bar, use the same clevs as in the contour
  ...
  ;opath='F:\lidar_data\output\'   ;output path Rayleigh\1995\se\se112342
   opath2='F:\lidar_data\'+yr+'\cirrus2009\';
    cname =opath2+yr+'_'+dnm+'_Cirrus.png
