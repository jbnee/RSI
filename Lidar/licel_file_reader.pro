...
; plot_position2 = [0.1,0.6,0.93,0.95]; plot_position2=[0.1,0.6,0.95,0.95]
  ...
  BAR_POSITION2=[0.97,0.5,0.98,0.95]
   ...
   contour,CPPM,x,y,xtitle='m channel time',ytitle='km',yrange=[0,3],LEVELS = CLEVS, /FILL,$
...
; plot_position2 = [0.1,0.6,0.93,0.95]; plot_position2=[0.1,0.6,0.95,0.95]
  ...
  ; h2=n3/0.0075 ; for licel height
   ...
   contour,CPPD,x,y,xtitle='D channel time',ytitle='km',yrange=[0,3],LEVELS = CLEVS, /FILL,$
    C_COLORS = C_INDEX, color=2,/FOLLOW
