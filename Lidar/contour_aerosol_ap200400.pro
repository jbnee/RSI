...
;path='d:\LidarPro\Rayleigh\1995\se\se112342.';.'
 ...
 FOR n=ni,nf do begin
  ...
  cmax=6000;1*max(pr2m[nf-ni-nx/2,0:100]);400;1500;500;./2
  cmin=500; cmax/50; cmax/10;min(pr2m[nf-ni-nx/2,0:200])
  ;nlevs=40
  ;nlevs_max=40
...
; xyouts,1.5*max(x),0.2*max(y),f3,/device
 ...
 FOR nd=ni+1,nf do begin
  ...
  col = 240 ; don't change it
  cmaxd=4.;4.0;1.5*max(pr2d[nf-ni-nx/2,0:30]);300;   0./5
  cmind=-0;.2;  .5;-0.3;cmaxd/50.
  nlevs_max=4.;0;10.0 ;increase to show background color
