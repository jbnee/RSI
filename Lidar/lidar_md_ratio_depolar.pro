...
;;;;;;;;;;;;;;;;Take signals between the range bn1:bn2;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

Xm0=pr2m[0,bn1:bn2-1]
plot,XM0,ht1,color=2 ,background=-2,xtitle='mean Pr2_m',position=plot_position1
    j2=0

FOR im=0 , nx-5, 5 do begin; average 5 profiles
...
plot,Xd0,ht1,color=2 ,background=-2,xtitle='mean Pr_d ',position=plot_position2

J3=0
FOR id=0,nx-5, 5 do begin; average 5 profiles
...
oplot,Xds[J3,*],ht,color=iy+5

j3=j3+1
endfor ;;;;id
stop

DEPOLAR=fltarr(n5,dbn)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 ctitle=yr+dnm
x=indgen(n5)+1
 contour,depolar,x,ht1,xtitle='channel time',ytitle='height (km)',yrange=[h1,h2],LEVELS = CLEVS, /FILL,$
 ...
 stop
    ...
    plot,depolar[1,*],ht1,background=-2,color=2,xrange=[0,1]
   ...
   bz=z*1000/dz
   mean_depolar=mean(depolar[*,bz])
   print,mean_depolar
   A_depolar=depolar[*,bz]
   plot,A_depolar,color=2,background=-2,title='ave depolar'
