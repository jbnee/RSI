...
path='d:\Lidar systems\Depolar\2002\mr\'
 ...
 !P.MULTI = [0, 1, 2]
  ...
  plot,pr2m[0,*],ht1,background=-2,color=2,yrange=[1,5],xrange=[0,maxs],$
 ...
 stop
 AVPr2m=fltarr(N5,1000)

 ;;;;;;;;;;;;;;;;;;;;Average every 5 profiles;;;;;;;;;;;;;;;;;;;;;;;;;;
 plot,pr2m[0,*],ht1,background=-2,color=2,yrange=[1,5],xrange=[0,maxs],position=Plot_Position1,$
  xtitle='Averge 5 Signal ',ytitle='km'
  J1=0
 FOR i=0 , nx-5, 5 do begin
 For iy=0,999 do begin
   AVPr2m[J1,iy]=MEAN(pr2m[i:i+4,iy])

  endfor  ;iy
  J1=J1+1
  endfor;  i
  plot,AVPr2m[0,*],ht1,background=-2,color=2,xrange=[0,maxs*5],yrange=[1,5],$
 position=Plot_position1,xtitle='Ave 5 Signal',ytitle='km';
  FOR Na=0,N5-1 do begin
  oplot,AVPr2m[Na,*]+10*b*NA,ht1,color=2
  endfor
...
oplot,STDS[m,*]+b*m/2,ht1,color=4
endfor
stop
