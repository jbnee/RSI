...
i0=1
 ...
 contour,pr2m,x,y,xtitle='m channel time',ytitle='km',yrange=[10,20],LEVELS = CLEVS, /FILL,$
 ...
 FOR nd=ni+1,nf do begin
  ...
  ENDFOR
   ...
   contour,pr2d,x,y,xtitle='d channel time',ytitle='km',title=dnm, yrange=[0,8],LEVELS = CLEVS, /FILL,$
