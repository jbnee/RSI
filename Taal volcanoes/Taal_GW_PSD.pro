...
Fit_T=poly(z,T_fit);
!P.multi=[0,1,1]
plot,Interp_T,Z,color=1,background=-2,xrange=[-20,20],yrange=[0,10],xtitle='temperature',ytitle='km',charsize=1.3
oplot,Fit_T,z,color=90;
stop

ANMT=Interp_T-Fit_T  ;temperature anomaly
;plot,fit_t,Z,color=2,background=-2

 oplot,anmt,z,psym=2,color=120
