pro read_hdf_wfc_1rs,path,FNAME          ;DPC RELEASE VERSION 3.4
;
...
; This Reader Version 3.4 corresponds to the Data Products Catalog Release 3.4.
...
nrec = HDF_VD_READ(vdata_id,W1RS_ORB_NUM_GRAN_START,fields='Orbit_Number_at_Granule_Start')
nrec = HDF_VD_READ(vdata_id,W1RS_ORB_NUM_GRAN_END,fields='Orbit_Number_at_Granule_End')
nrec = HDF_VD_READ(vdata_id,W1RS_ORB_NUM_CHANG_TIM,fields='Orbit_Number_Change_Time')
nrec = HDF_VD_READ(vdata_id,W1RS_PATH_NUM_GRAN_START,fields='Path_Number_at_Granule_Start')
nrec = HDF_VD_READ(vdata_id,W1RS_PATH_NUM_GRAN_END,fields='Path_Number_at_Granule_End')
nrec = HDF_VD_READ(vdata_id,W1RS_PATH_NUM_CHANG_TIM,fields='Path_Number_Change_Time')
...
print,'Orbit_Number_at_Granule_Start = ', W1RS_ORB_NUM_GRAN_START
print,'Orbit_Number_at_Granule_End = ', W1RS_ORB_NUM_GRAN_END
print,'Orbit_Number_at_Change_Time= ', W1RS_ORB_NUM_CHANG_TIM
print,'Path_Number_at_Granule_Start = ', W1RS_PATH_NUM_GRAN_START
print,'Path_Number_at_Granule_End = ', W1RS_PATH_NUM_GRAN_END
print,'Path_Number_at_Change_Time= ', W1RS_PATH_NUM_CHANG_TIM
