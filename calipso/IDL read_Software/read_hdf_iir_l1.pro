...
; This reader version 3.5 corresponds to the Data Products Catalog Release 2.4.
...
; February 28, 2011     PTD (Science Systems & Applications, Inc.)  Read Software update only
;
...
if var eq 'Longitude' then HDF_SD_GETDATA,sds_id,IIR_LON
if var eq 'Lidar_Shot_Time' then HDF_SD_GETDATA,sds_id,IIR_LIDAR_SHOT_TIME
...
if var eq 'Image_UTC_Time_8.65' then HDF_SD_GETDATA,sds_id,IIR_IMG_UTC_8
if var eq 'Viewing_Zenith_Angle_8.65' then HDF_SD_GETDATA,sds_id,IIR_ZNTH_8
...
if var eq 'Calibrated_Radiances_8.65' then HDF_SD_GETDATA,sds_id,IIR_CAL_RAD_8
if var eq 'Image_Time_12.05' then HDF_SD_GETDATA,sds_id,IIR_IMG_TIME_12
...
if var eq 'Sequence_Number_10.6' then HDF_SD_GETDATA,sds_id,IIR_SEQNUM_10
if var eq 'Calibrated_Radiances_10.6' then HDF_SD_GETDATA,sds_id,IIR_CAL_RAD_10
if var eq 'Pixel_Quality_Index' then HDF_SD_GETDATA,sds_id,IIR_PXL_QLTY

;TABLE 13 PARAMETERS

if var eq 'Time_TAI_8.65' then HDF_SD_GETDATA,sds_id,IIR_TAI_8
if var eq 'Time_UTC_8.65' then HDF_SD_GETDATA,sds_id,IIR_UTC_8
if var eq 'Spacecraft_Position_8.65' then HDF_SD_GETDATA,sds_id,IIR_SPC_POS_8
if var eq 'Spacecraft_Velocity_8.65' then HDF_SD_GETDATA,sds_id,IIR_SPC_VEL_8
