pro read_hdf_wfc_125,path,FNAME          ;DPC RELEASE VERSION 3.4
;
...
nrec = HDF_VD_READ(vdata_id,W125_ORB_NUM_GRAN_START,fields='Orbit_Number_at_Granule_Start')
nrec = HDF_VD_READ(vdata_id,W125_ORB_NUM_GRAN_END,fields='Orbit_Number_at_Granule_End')
nrec = HDF_VD_READ(vdata_id,W125_ORB_NUM_CHANG_TIM,fields='Orbit_Number_Change_Time')
nrec = HDF_VD_READ(vdata_id,W125_PATH_NUM_GRAN_START,fields='Path_Number_at_Granule_Start')
nrec = HDF_VD_READ(vdata_id,W125_PATH_NUM_GRAN_END,fields='Path_Number_at_Granule_End')
nrec = HDF_VD_READ(vdata_id,W125_PATH_NUM_CHANG_TIM,fields='Path_Number_Change_Time')
...
print,'Orbit_Number_at_Granule_Start = ', W125_ORB_NUM_GRAN_START
print,'Orbit_Number_at_Granule_End = ', W125_ORB_NUM_GRAN_END
print,'Orbit_Number_at_Change_Time= ', W125_ORB_NUM_CHANG_TIM
print,'Path_Number_at_Granule_Start = ', W125_PATH_NUM_GRAN_START
print,'Path_Number_at_Granule_End = ', W125_PATH_NUM_GRAN_END
print,'Path_Number_at_Change_Time= ', W125_PATH_NUM_CHANG_TIM

; The print statement below prints out the W125_PXL_QC_FLAG which is the Pixel_QC_Flag
