pro read_hdf_l2_al05,path,FNAME          ;DPC RELEASE VERSION 3.4
;
...
; Lidar Level 2 5km Aersol Column and Layer Common (L2_AL05_COMMON.pro)
; The user can comment out any assignments not required for their application.
; This Reader Version 3.2v1 corresponds to the Data Products (DP) Catalog Release 3.4.
...
; February 28, 2011	Science Systems & Applications, Inc.       Read Software update
