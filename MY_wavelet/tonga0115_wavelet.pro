...
!P.COLOR=2 ;blue labels
 ...
 fpath='E:\rsi\wavelet_lombscargle\'  ;sun_spot.txt'
  F1='E:\RSI\Tonga volcano\FFT out\As0115.txt'
  ;finm=fpath+datanm
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
AS=fltarr(1200,8000)
line=''
...
T4am=Total(V[0:399,*],1) ;total data number for 0-4am
stop
dz=3.75/1000.
Ht=indgen(8000)*dz  ;dkm=(km[N-1]-km[0])/N;
...
BAR_0=[0.94,0.2,0.96,0.9]
      CONTOUR,power,ht,period,yrange=[1,20],ytickinterval=2, $
 ...
 CONTOUR,ABS(wave)^2/signif,ht,period, $
       /OVERPLOT,LEVEL=1.0,C_ANNOT='95%'
 PLOTS,Ht,coi,NOCLIP=0;     ;*** anything "below" this line is dubious
 close,1
stop
...
stop
 ...
 fpath='e:\rsi\tonga volcano 2022\test\'
 outname='T01154am'
