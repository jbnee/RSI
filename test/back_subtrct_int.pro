...
pro back_sbtrct_int_cdf
;-----------------------
; run the file 'sddc_read_cdf' to get ISUAL CDF airglow data file,
; make background emission data
; subtract the background emissions
; plot the original image and the background emission subtracted data
; convert counts to Rayleighs using IM_intensity.pro
;
; no output file.
; input: 1) month and date as mmdd
;        2) image number between 0 ans 128
;
; Shengpan Zhang
; Oct. 2007
; NCU, Taiwan
