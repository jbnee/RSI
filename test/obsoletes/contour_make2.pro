...
CONTOUR, DATA_PLOT, X,Y, title='test 0715',XSTYLE =1,YTITLE='height',POSITION= PLOT_POSITION,$
...
ENDFOR
CONTOUR, DATA_PLOT,X,Y,LEVELS = CLEVS,title='0714',$
...
xyouts,0.0,cmax*1.01,'P0000',charsize=0.9,color=2
