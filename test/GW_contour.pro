...
BK=360.
data_plot=z
openr,1,'e:\rsi\test\GWx007.txt'
readf,1,x
openr,2,'e:\rsi\test\GWy007.txt'
readf,2,y
openr,3,'e:\rsi\test\GWz007.txt'
readf,3,z
z=z-BK  ;remove background
close,/all
minx = min(x)
maxx = max(x)
miny = min(y)
...
POSITION= PLOT_POSITION2,YTITLE = 'Long', xtitle='Latitude',/noerase
