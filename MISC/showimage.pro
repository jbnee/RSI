...
; $Id: showimage.pro,v 1.16 1999/11/28 21:06:16 gumley Exp $
;
...
rcs_id = '$Id: showimage.pro,v 1.16 1999/11/28 21:06:16 gumley Exp $'
...
if not keyword_set(current) then begin
  ...
  screen_xsize = screen[0]
  screen_ysize = screen[1]
  if (nx gt screen_xsize) then begin
    xsize = 0.9 * screen_xsize
    scroll = 1
  endif
  if (ny gt screen_ysize) then begin
    ysize = 0.9 * screen_ysize
    scroll = 1
  endif
