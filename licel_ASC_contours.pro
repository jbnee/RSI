...
maxa=max(meanAS1)
plot,meanAS2,ht,color=2, background=1,xrange=[0,maxa],yrange=[h1,h2],xtitle='count',ytitle='km',$
   title=XC+'for every 5 data' ,charsize=2
...
!P.COLOR=2 ;blue labels
 ...
 ; CPPD=A[0:m-1,*] ; analog
     ...
     cmax=2*max(CPPM1[m/4,bn2-500,bn2-5]);for high altitud
